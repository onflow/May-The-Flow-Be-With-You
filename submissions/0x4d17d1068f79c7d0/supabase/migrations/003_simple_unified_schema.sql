-- SIMPLIFIED UNIFIED SCHEMA - NO RLS ISSUES
-- This creates the unified tables without complex RLS policies

-- Enable required extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ============================================================================
-- STEP 1: CREATE UNIFIED TABLES (without RLS for now)
-- ============================================================================
...
-- ============================================================================
-- STEP 3: DISABLE RLS FOR DEVELOPMENT (we'll add proper RLS later)
-- ============================================================================

-- Disable RLS for now to avoid UUID casting issues
ALTER TABLE user_profiles DISABLE ROW LEVEL SECURITY;
ALTER TABLE game_sessions DISABLE ROW LEVEL SECURITY;
ALTER TABLE leaderboards DISABLE ROW LEVEL SECURITY;
ALTER TABLE achievements DISABLE ROW LEVEL SECURITY;
ALTER TABLE user_progress DISABLE ROW LEVEL SECURITY;
ALTER TABLE memory_palaces DISABLE ROW LEVEL SECURITY;
...
SELECT 'Note: RLS is disabled for development. Your unified database is ready!' as note;
