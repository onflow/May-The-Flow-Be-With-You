...
export function VRFVerification({ verificationData, gameMode, className = "" }: VRFVerificationProps) {
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="font-medium text-gray-900 dark:text-white">
              {gameMode === 'onchain' ? 'Flow VRF Randomness' : 'Local Randomness'}
            </div>
        ...
        <div className="mt-3 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <div className="text-sm text-blue-800 dark:text-blue-200">
              <strong>
                {gameMode === 'onchain' ? 'Flow VRF Verification:' : 'Local Randomness:'}
              </strong>
              <p className="mt-1">
                {gameMode === 'onchain' 
          ...
          {gameMode === 'onchain' && verificationData.verificationUrl && (
            <div className="mt-4 flex space-x-3">
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(verificationData.transactionId || '');
                }}
        ...
        <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-green-800 dark:text-green-200">
              <strong>Competitive Advantage:</strong> Your game results are cryptographically verified and cannot be manipulated, ensuring fair competition in tournaments and leaderboards.
            </div>
          </div>
        </div>
      )}
...
export function VRFBadge({ verificationData, gameMode }: { verificationData: RandomnessVerification | null; gameMode: 'offchain' | 'onchain' }) {
