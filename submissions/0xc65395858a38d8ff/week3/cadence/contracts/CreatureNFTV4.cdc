...
access(all) contract CreatureNFTV4: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver {
        ...
        access(all) fun changeInitialSeed(newSeedBase: UInt64): Bool {
            ...
            // Emitir evento
            emit CreatureNFTV4.InitialSeedChanged(
                creatureID: self.id,
                oldSeed: oldSeed,
                newSeed: newSeed,
        ...
        access(all) fun updateGenesForStep(r0VolSeed: UInt64, r1PasSeed: UInt64, r2BoostHomeoSeed: UInt64, r3HomeoEfecSeed: UInt64, stepsPerDay: UInt64) {
            ...
            for geneName in self.genesVisibles.keys {
                ...
                if self.homeostasisTargets[geneName] != nil {
                    ...
                    var cambioHomeostasis = diferencia * CreatureNFTV4.TASA_APRENDIZAJE_HOMEOSTASIS_BASE * potencialEvolutivo 
                    ...
                    let magnitude_Vis = CreatureNFTV4.TASA_EVOLUCION_PASIVA_GEN_BASE * potencialEvolutivo * dailyVolatilityFactor
                    ...
                    if randomNormalized_Vis < 0.5 {
                        ...
                        if currentValue > changeAmount_Vis {
                            ...
                            if let geneRange = CreatureNFTV4.GENES_VISIBLES_RANGES[geneName] {
                ...
                self.genesVisibles[geneName] = self.clampValue(currentValue, geneName, CreatureNFTV4.GENES_VISIBLES_RANGES)
        ...
        access(all) fun _updateCombatGenesForStep(r0VolSeed: UInt64, r1PasSeedStep: UInt64, stepsPerDay: UInt64) {
            ...
            if let rangoTB = CreatureNFTV4.GENES_VISIBLES_RANGES["tamanoBase"] {
            ...
            if let rangoNA = CreatureNFTV4.GENES_VISIBLES_RANGES["numApendices"] {
            ...
            for geneNombreOculto in genesCombate {
                ...
                let minGeneValue = CreatureNFTV4.GENES_OCULTOS_RANGES[geneNombreOculto]!["min"]!

                // 1. Cambio base aleatorio pasivo
                let randomNormalized_Hid = UFix64(r1PasSeedStep % 10000) / 9999.0 // Rango [0.0, 1.0]
                let magnitude_Hid = CreatureNFTV4.TASA_EVOLUCION_PASIVA_GEN_BASE * potencialEvolutivo * dailyVolatilityFactor
                ...
                let factorEvolucionInfluenciaBase = CreatureNFTV4.FACTOR_INFLUENCIA_VISUAL_SOBRE_COMBATE * potencialEvolutivo * dailyVolatilityFactor
                ...
                self.genesOcultos[geneNombreOculto] = self.clampValue(currentValue, geneNombreOculto, CreatureNFTV4.GENES_OCULTOS_RANGES)
            }
        }
        ...
        access(all) fun gainEvolutionPointsForStep(r0: UInt64, stepsPerDay: UInt64) {
            ...
            let PYTHON_BASE_FACTOR = 0.002 // Corresponde a FACTOR_GANANCIA_EP_POR_TIMESTEP en Python
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return CreatureNFTV4.resolveContractView(resourceType: Type<@CreatureNFTV4.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return CreatureNFTV4.resolveContractView(resourceType: Type<@CreatureNFTV4.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
            }
            return nil
        }

        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-CreatureNFTV4.createEmptyCollection(nftType: Type<@CreatureNFTV4.NFT>())
        }
        ...
        access(all) fun performMitosis(epCost: UFix64): @NFT? {
            ...
            let childPotencialBase = parentPotencial * CreatureNFTV4.MITOSIS_POTENCIAL_BASE_INHERITANCE_FACTOR
            let potencialEpBonus = epCost * CreatureNFTV4.MITOSIS_POTENCIAL_EP_BONUS_FACTOR
            var finalChildPotencial = childPotencialBase + potencialEpBonus
            
            // Clamp potencial evolutivo del hijo
            if let potencialRanges = CreatureNFTV4.GENES_OCULTOS_RANGES["potencialEvolutivo"] {
            ...
            let baseLifespanForChild = self.lifespanTotalSimulatedDays * CreatureNFTV4.MITOSIS_LIFESPAN_BASE_FACTOR
            let lifespanEpBonus = epCost * CreatureNFTV4.MITOSIS_LIFESPAN_EP_BONUS_FACTOR
            ...
            CreatureNFTV4.totalSupply = CreatureNFTV4.totalSupply + 1
            let newID = CreatureNFTV4.totalSupply
    ...
    access(all) resource interface CollectionPublic {
        ...
        access(all) view fun borrowCreatureNFT(id: UInt64): &CreatureNFTV4.NFT?
    ...
    access(all) resource Collection: NonFungibleToken.Collection, CollectionPublic {
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            let token <- token as! @CreatureNFTV4.NFT
            let id: UInt64 = token.id
            
            // Verificar si está viva y gestionar límite
            if token.estaViva {
                if UInt64(self.activeCreatureIDs.length) >= CreatureNFTV4.MAX_ACTIVE_CREATURES {
        ...
        access(all) view fun borrowCreatureNFT(id: UInt64): &CreatureNFTV4.NFT? {
            if self.ownedNFTs[id] != nil {
                ...
                return ref as! &CreatureNFTV4.NFT
            }
            return nil
        }
        
        /// Gets an authorized reference to a specific NFT that can be modified
        access(all) fun borrowCreatureNFTForUpdate(id: UInt64): auth(Mutate, Insert, Remove) &CreatureNFTV4.NFT? {
            if self.ownedNFTs[id] != nil {
                let ref = &self.ownedNFTs[id] as auth(Mutate, Insert, Remove) &{NonFungibleToken.NFT}?
                return ref as! auth(Mutate, Insert, Remove) &CreatureNFTV4.NFT
            }
            return nil
        }
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@CreatureNFTV4.NFT>()] = true
            return supportedTypes
        }

        /// Returns whether or not the given type is accepted by the collection
        access(all) view fun isSupportedNFTType(type: Type): Bool {
            return type == Type<@CreatureNFTV4.NFT>()
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&CreatureNFTV4.Collection>(),
                    publicLinkedType: Type<&CreatureNFTV4.Collection>(),
    ...
    init() {
        ...
        // Set the named paths
        self.CollectionStoragePath = /storage/CreatureNFTV4Collection
        self.CollectionPublicPath = /public/CreatureNFTV4Collection
        self.MinterStoragePath = /storage/CreatureNFTV4Minter
