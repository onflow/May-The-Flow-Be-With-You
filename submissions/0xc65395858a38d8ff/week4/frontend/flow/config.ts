...
config({
  ...
  // Para Testnet, si has desplegado EvolvingCreatureNFT con tu cuenta `testnet-deployer` (0x2444e6b4d9327f09):
  "0xEvolvingCreatureNFT": "0x2444e6b4d9327f09", // Reemplaza con la dirección real de tu contrato en Testnet/Mainnet
  
  // Módulos del nuevo sistema modular
  "0xTraitModule": "0x2444e6b4d9327f09",
  "0xVisualTraitsModule": "0x2444e6b4d9327f09", 
  "0xAdvancedVisualTraitsModule": "0x2444e6b4d9327f09",
  "0xCombatStatsModule": "0x2444e6b4d9327f09",
  ...
  // "0xEvolvingCreatureNFT": "0xf8d6e0586b0a20c7", // Ejemplo para Emulador
});

console.log("FCL Configured:", config().get("accessNode.api"), config().get("0xEvolvingCreatureNFT")); 