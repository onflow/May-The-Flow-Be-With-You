...
export const Layout = ({ children }: { children: React.ReactNode }) => (
  <NavigationLoader>
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex flex-col safe-area-padding">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-3 sm:p-4 lg:p-8 space-y-4 sm:space-y-8">
        <div className="w-full max-w-4xl">
          <div className="bg-white/60 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 lg:p-8">
            {children}
          </div>
        </div>
      </main>
